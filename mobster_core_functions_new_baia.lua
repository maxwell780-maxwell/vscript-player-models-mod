if SERVER then
    ...
    local mobsterModel = "models/vip_mobster/player/mobster_new.mdl"
    ...
    -- Hook definitions
    hook.Add("Think", "backatitagainnewMobsterMoneybagThrowSound", function()
    ...
    hook.Add("PlayerSpawn", "backatitagainnewMobsterInit", function(ply)
    ...
    hook.Add("EntityTakeDamage", "backatitagainnewMobsterPainSounds", function(target, dmginfo)
    ...
    hook.Add("PlayerDeath", "backatitagainnewMobsterDeathSounds", function(ply, inflictor, attacker)
        if not IsMobster(ply) then return end
    ...
    hook.Add("Think", "backatitagainnewMobsterLeaveSpawnSound", function()
        for _, ply in ipairs(player.GetAll()) do
    ...
    hook.Add("OnNPCKilled", "backatitagainnewMobsterKillSound", function(npc, attacker, inflictor)
    ...
    hook.Add("PlayerDeath", "backatitagainnewMobsterKillPlayer", function(victim, inflictor, attacker)
    ...
    hook.Add("EntityRemoved", "backatitagainnewMobsterKillNextbot", function(entity)
    ...
    hook.Add("PlayerDisconnected", "backatitagainnewCleanupMobsterLipSync", function(ply)
        if ply._lipSyncTimer then
            timer.Remove(ply._lipSyncTimer)
        end
