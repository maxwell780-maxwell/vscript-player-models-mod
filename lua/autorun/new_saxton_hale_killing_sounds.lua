if SERVER then
    ...
    local kill_sounds = {
        ...
        "mvm/saxton_hale_karijini/kill_generic_01.mp3",
        "mvm/saxton_hale_karijini/kill_generic_02.mp3",
        "mvm/saxton_hale_karijini/kill_generic_03.mp3"
    }
    ...
    hook.Add("OnNPCKilled", "NEWSaxtonHaleKillSound", function(victim, attacker)
