...
if CLIENT then
    ...
    hook.Add("OnPlayerModelChanged", "MobsterHandsSkinSync", UpdateHandsSkin)
    
    -- Hook into skin changes
    hook.Add("PlayerSetSkin", "MobsterHandsSkinSync", function(ply)
    ...
    hook.Add("InitPostEntity", "MobsterHandsSkinSync_Initial", function()
    ...
    timer.Create("MobsterHandsSkinSync_Timer", 1, 0, UpdateHandsSkin)
end